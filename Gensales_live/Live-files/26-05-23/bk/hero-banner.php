...
<style>
    ...
    div#field_12_21 label.gfield_label.gform-field-label {
    display: none;
}
...
/* label.gfield_label.gform-field-label {
    ...
    .sub-content form#gform_12 input {
    height: 35px;
}
...
form#gform_12 .gform_wrapper.gravity-theme #field_submit, form#gform_12 .gform_wrapper.gravity-theme .gform_footer{
    justify-content: end;
}
form#gform_12 .gform_wrapper.gravity-theme #field_submit input, form#gform_12 .gform_wrapper.gravity-theme .gform_footer input{
    align-self: center;
}
