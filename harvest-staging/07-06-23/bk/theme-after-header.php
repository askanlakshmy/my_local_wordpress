...
//     $('.mega_menu_custom .newSpan').on('click', function() {
//     $('.menu-item-49948').toggleClass('menu_open');
//     $('.menu-item-49948').addClass('menu_open1');
//   });
//   $('.mega_menu_custom .newSpan').on('click', function() {
//     $('.menu-item-49982 > ul').toggleClass('first_menu');
// });  
// });
...
<li><a href="">In The News</a>
   <ul class="sub-menu mm">
    <li class="listL">
    <div class="menu_fea"><span>Featured |<a href="" style="color: #cdb460;">View all</a></span></div>
    <div class="feature_image">
        <div class="feature_cards">
            <img src="https://harvestetfsdev.wpengine.com/wp-content/uploads/2023/07/Rectangle-102.png">
            <div class="content_c">
                <h3>Harvest Declares Big Pharma Split Corp. April 2023 Distributions</h3>
    ...
    <li>
    <div class="feature_image im2">
        <div class="feature_cards">
            <img src="https://harvestetfsdev.wpengine.com/wp-content/uploads/2023/07/Rectangle-103.png">
            <div class="content_c">
                <h3>Harvest Announces Listing of Harvest Travel & Leisure Income ETF</h3>
                <a href="">Read press release</a>
            </div>
        </div>
    </div>
...
<!-- </ul> -->
	...
	<div class="lang_sec">
		<div class="list_lang">
			<ul><li><a href="/">En</a></li><li><a href="/fr-CA">Fr</a></li></ul>
		</div>
	</div>
