...
function et_setup_theme() {
	...
	register_nav_menus( array(
		...
		'new-menu' => esc_html__( 'new Menu'),
		'insigts-learing' => esc_html__( 'insigts learing'),
		'menu-media' => esc_html__( 'media-menu'),
		'about-harvest' => esc_html__( 'about harvest'),
...
/*media submenu one*/
	function wpb_widgets_init1() {
		register_sidebar( array(
			'name' => __( 'Media Submenu One', 'wpb' ),
			'id' => 'media_submenu_one',
			'description' => __( 'The bottom bar appears on each page', 'wpb' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
...
function wpb_widgets_init2() {
			register_sidebar( array(
				'name' => __( 'Media Submenu two', 'wpb' ),
				'id' => 'media_submenu_two',
				'description' => __( 'The bottom bar appears on each page', 'wpb' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
				'before_title' => '<h3 class="widget-title">',
...
function wpb_widgets_init3() {
	register_sidebar( array(
		'name' => __( 'Media Submenu three', 'wpb' ),
		'id' => 'media_submenu_three',
		'description' => __( 'The bottom bar appears on each page', 'wpb' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
...
function wpb_widgets_init4() {
	register_sidebar( array(
		'name' => __( 'Media Submenu four', 'wpb' ),
		'id' => 'media_submenu_four',
		'description' => __( 'The bottom bar appears on each page', 'wpb' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
...
add_action( 'widgets_init', 'wpb_widgets_init4' );