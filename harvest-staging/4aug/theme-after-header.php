...
@media screen and (min-width:1280px) and (max-width:1535px){
    button.button.button-default{    margin-right: -4px !important;}
.subm_menu ul.sub-menu {
    width: 65% !important;
}
.feature_image img{
...
.fix{    margin-top: 1.23rem !important;}
    /* .product_sub_menu, .product_sub_menu1, .product_sub_menu2, .product_sub_menu3{
        top: 94.5px;
    }
...
@media screen and (min-width:1212px) and (max-width:1600px){
    .about_harves .fix,.menu_media .fix{height: 26.1rem;}
    .product_menu .fix{height: 27rem;}
    .insights_eductation .fix {
    height: 13rem !important;
}
    .product_sub_menu, .product_sub_menu1, .product_sub_menu2, .product_sub_menu3{top: 3.45rem;}
    .main_menu, .main_menu1, .main_menu2, .main_menu3{width:auto !important;}
    html body .subm_menu ul.sub-menu{    padding-left: 1rem !important;}
...
.fix{
    ...
    .product_menu:hover .fix,.removed_sub_menu:hover .fix {
    display: block;
}
.product_sub_menu.selected, .product_sub_menu1.selected1, .product_sub_menu2.selected2, .product_sub_menu3.selected3{
...
@media screen and (min-width:1801px) and (max-width:2099px){
...
@media screen and (min-width:1801px){
    ...
    /* html body .sticky .product_sub_menu,html body .sticky .product_sub_menu1,html body .sticky .product_sub_menu2, html body .sticky .product_sub_menu3{    top: 3.3rem !important;} */
    .product_sub_menu.selected, .product_sub_menu1.selected1, .product_sub_menu2.selected2, .product_sub_menu3.selected3{
        transform: inherit !important;
    }
    .product_menu:hover .fix,.removed_sub_menu:hover .fix {
    ...
    .product_sub_menu.selected .borchure {
    ...
    .main_menu, .main_menu1, .main_menu2, .main_menu3{width:auto !important;}
    html body .subm_menu ul.sub-menu{    left: 29% !important;}
    .subm_menu ul.sub-menu {
    width: 75% !important;
}
...
@media screen and (min-width:1280px) and (max-width:1399px){
    ul#menu-new-menu li a{    padding: 31px 5px 18px 5px;}
    .fix{    margin-top: 1.1rem !important;}
    .product_sub_menu, .product_sub_menu1, .product_sub_menu2, .product_sub_menu3 {
