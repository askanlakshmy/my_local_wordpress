...
<!--<![endif]-->
<head>
	<script src="https://www.googleoptimize.com/optimize.js?id=OPT-KN33MLS"></script><!--NPD Google Optimize Snippet-->
	...
	<?php if ( $et_top_info_defined && ! $et_slide_header || is_customize_preview() ) : ?>
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<div id="et-info">
                	<!-- NEW ADD SIGNUP FOR NEWSLETTER LINK -->
	                <a href="/subscribe/" class="signup">Subscribe to our NEWS  </a>
	...
	<?php if ( $et_slide_header || is_customize_preview() ) : ?>
		<div class="et_slide_in_menu_container">
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<div id="et-info">
                <!-- NEW ADD SIGNUP FOR NEWSLETTER LINK -->
                <a href="/subscribe/" class="signup">Sign Up For Our Newsletter</a>
				<?php if ( '' !== ( $et_phone_number = et_get_option( 'phone_number' ) ) ) : ?>
					<span id="et-info-phone"><?php echo et_sanitize_html_input_text( $et_phone_number ); ?></span>
				<?php endif; ?>
