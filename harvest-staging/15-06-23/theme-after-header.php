...
@media screen and (min-width:1601px) and (max-width:1800px){
    html body .sticky .product_sub_menu {
    top: 74px !important;
}
    html body ul#menu-new-menu li a{
        padding: 25px 21px 23px 0;
    }
    .product_sub_menu, .product_sub_menu1, .product_sub_menu2, .product_sub_menu3{
        top:106px !important;
    }
...
.sticky .product_sub_menu{top: 72px !important;}
...
@media screen and (min-width:1536px){
    header#custom_header .container{    width: 92% !important;}
