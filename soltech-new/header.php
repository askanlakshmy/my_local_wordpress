...
@media screen and (min-width:1280px) and (max-width:1599px){
	...
	@media screen and (min-width:1200px){
		header .Box_header .soltech-head .Form form button svg{
			width: 16px !important;
		}
		html body .menu-below-head ul li.belowmenu-contact a{
			padding: 8px 25px !important;
		}
		.Header .Form.Form_with_ajax {
    position: relative;
}
		ul.Results_search {
    position: absolute;
...
.soltech-menu{
	margin-bottom: 10px;
		...
		header .Box_header .soltech-head .Form form input{
