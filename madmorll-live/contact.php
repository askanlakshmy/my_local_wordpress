        ...
        <div class="divi_two">
            <div class="left_info_contact">
                <div class="box_coloru">
                    ...
                    <div class="cont_in">
                        <ul>
                            <li><img src="/wp-content/uploads/2023/02/telephone-new.png"><a href="<?php echo get_field('contact_link'); ?>"><?php echo get_field('contact_number'); ?></a></li>
                            <li><img src="/wp-content/uploads/2023/02/email.png"><a href="<?php echo get_field('contact_content_link'); ?>"><?php echo get_field('contact_email'); ?></a></li>
                        </ul>
                    </div>
                    <div class="social-icon-contact">
                         <ul>
                             <li><a href="<?php echo get_field('contact_facebook'); ?>"><img src="/wp-content/uploads/2023/02/facebook-app-symbol.png" alt="facebook"></a></li>
                             <li><a href="<?php echo get_field('contact_twitter'); ?>"><img src="/wp-content/uploads/2023/02/twitter.png" alt="twitter"></a></li>
                             <li><a href="<?php echo get_field('contact_insta'); ?>"><img src="/wp-content/uploads/2023/02/instagram.png" alt="instagram"></a></li>
