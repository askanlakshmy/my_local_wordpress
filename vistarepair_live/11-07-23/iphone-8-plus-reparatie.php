...
<style>
    section.buttonsection{margin-bottom:0 !important;}
    .four-button-division-row{
        justify-content: center;
    }
    .four-button-division-row-button1{
...
<section class="buttonsection"><div class="four-button-division">
<div class="four-button-division-row">
<?php $i=1;if (have_rows('button-iphone','option')) : ?>
 <?php while (have_rows('button-iphone','option')) : the_row(); ?>
<div class="four-button-division-row-button<?php echo $i; ?> animation-elements1 slide-left in-views1">
<a href="<?php echo get_sub_field('link_iphone');?>" class="button<?php echo $i; ?>-rep"><?php echo get_sub_field('iphone_8_name'); ?></a></div>
<?php endwhile;?>
<?php $i++; endif; ?>
<!-- <div class="four-button-division-row-button2 animation-element18 bounce-up18 in-view18 in-view30">
<a href="https://vistarepair.nl/toestel-opsturen/" class="button2-rep">Toestel opsturen</a></div>
<div class="four-button-division-row-button3 animation-element18 bounce-up18 in-view18 in-view30">
<a href="https://vistarepair.nl/contact/" class="button3-rep">Stuur een e-mail</a></div>
<div class="four-button-division-row-button4 animation-elements23 slide-right in-view23">
<a href="https://vistarepair.nl/offerte-aanvragen/" class="button4-rep">Vraag offerte aan</a>
</div> -->
</div></div></section>
                                            ...
                                            <div class="iphonecard-wrap1">
                                                ...
                                                <div class="iphonecard-image">
                                                    ...
                                                    <?php $arrow_content = get_sub_field('iphone-8-cardmeer');?>
                                                        ...
                                                        <span class="iphone-8-cardmeer"><?php echo get_sub_field('iphone-8-cardmeer');?></span>
