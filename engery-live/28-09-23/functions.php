    ...
    <ul class="social-icons">
        <div class="nc_socialPanel swp_flatFresh swp_d_fullColor swp_i_fullColor swp_o_fullColor scale-100 scale-fullWidth" data-position="both" data-float="floatNone" data-count="6" data-floatColor="#ffffff" data-emphasize="0">
            ...
            <div class="nc_tweetContainer swp_fb" data-id="4" data-network="facebook">
                <a rel="nofollow" target="_blank" data-link="javascript:void(0)" class="nc_tweet1" onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.facebook.com/totalfrequencyshift">
            ...
            <div class="nc_tweetContainer insta_link inner">
            <a rel="nofollow" target="_blank" data-link="javascript:void(0)" class="nc_tweet1" onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.instagram.com/energytherapyuk" target="_blank" class="nc_tweet1">
                    <span class="iconFiller">
                        <span class="spaceManWilly">
            ...
            <div class="nc_tweetContainer youtube_link">
                <a rel="nofollow" onclick="javascript:popupCenter('https://www.youtube.com"  href="https://www.youtube.com/@energytherapyBiz" target="_blank" class="nc_tweet1">
                    <span class="iconFiller">
                        <span class="spaceManWilly">
                        <i class='fa fa-youtube' style='color: white' id="demo"></i>
                            <span class="swp_share"> Share</span>
                        </span>
                    </span>
                    <span class="swp_count my_count" data-sc-ln="<?php the_permalink(); ?>" ></span>
            ...
            <div class="nc_tweetContainer nc_pinterest" data-id="6" data-network="pinterest">
                <a rel="nofollow" href="https://www.pinterest.com/energytherapyuk" onclick="var e=document.createElement('script');e.setAttribute('type','text/javascript');e.setAttribute('charset','UTF-8');e.setAttribute('src','//assets.pinterest.com/js/pinmarklet.js?r='+Math.random()*99999999);document.body.appendChild(e);" class="nc_tweet noPop">
                    <span class="iconFiller">
                        <span class="spaceManWilly">
...
function ds_social_share_icons() {
    ...
    <ul class="social-icons">
        <div class="nc_socialPanel swp_flatFresh swp_d_fullColor swp_i_fullColor swp_o_fullColor scale-100 scale-fullWidth" data-post-id="<?php echo $post_id; ?>" data-position="both" data-float="floatNone" data-count="6" data-floatColor="#ffffff" data-emphasize="0">
            ...
            <div class="nc_tweetContainer swp_fb" data-id="4" data-network="facebook">
                <a rel="nofollow" target="_blank" data-link="javascript:void(0)" class="nc_tweet1" onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; //the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.facebook.com/totalfrequencyshift">
                    <span class="iconFiller">
                        <span class="spaceManWilly">
                            <i class="sw sw-facebook"></i>
                            <span class="swp_share"> Share</span>
            ...
            <div class="nc_tweetContainer insta_link inner2">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; //the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" rel="nofollow" href="https://www.instagram.com/energytherapyuk" target="_blank" class="nc_tweet1">
                    <span class="iconFiller">
                        <span class="spaceManWilly">
                        <i class='fa fa-instagram'></i>
                            <span class="swp_share"> Share</span>
            ...
            <div class="nc_tweetContainer youtube_link">
                <a rel="nofollow" onclick="javascript:popupCenter('https://www.youtube.com
                " href="https://www.youtube.com/@energytherapyBiz" target="_blank" class="nc_tweet1">
                    <span class="iconFiller">
                        <span class="spaceManWilly">
            ...
            <div class="nc_tweetContainer twitter" data-id="3" data-network="twitter">
                <a rel="nofollow" target="_blank" onclick="javascript:popupCenter('https://twitter.com/share?&amp;url=<?php  echo $shortlink = wpbitly_get_shortlink_custom($endpoint,$params); ?>&amp;text=<?php the_title(); ?>&amp;via=energy_therapy','Tweet', '540', '400');return false;" href="https://www.twitter.com/energy_therapy" class="nc_tweet1">
                    <span class="iconFiller">
                        <span class="spaceManWilly">
                            <i class="sw sw-twitter"></i>
                            <span class="swp_share"> Tweet</span>
            ...
            <?php } else { ?>
            <div class="nc_tweetContainer twitter" data-id="3" data-network="twitter">
                <a rel="nofollow" target="_blank" onclick="javascript:popupCenter('https://twitter.com/share?&amp;url=<?php  echo $shortlink = wpbitly_get_shortlink_custom($permalink, $post_id); ?>&amp;text=<?php the_title(); ?>&amp;via=energy_therapy','Tweet', '540', '400');return false;" href="https://www.twitter.com/energy_therapy" class="nc_tweet1">
                    <span class="iconFiller">
                        <span class="spaceManWilly">
                            <i class="sw sw-twitter"></i>
                            <span class="swp_share"> Tweet</span>
            ...
            <div class="nc_tweetContainer linkedIn" data-id="5" data-network="linked_in">
                <a rel="nofollow" onclick="javascript:popupCenter('http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $shortlink = wpbitly_get_shortlink_custom($endpoint,$params); //echo $shortlink = wpwpbitly_get_shortlink_custom$link); // ?>&amp;title=<?php the_title(); ?>&amp;source=<?php echo site_url(); ?>','Share on LinkedIn', '520', '570');return false;" href="https://www.linkedin.com/in/energytherapyuk" target="blank" data-link="javascript:void(0)" class="nc_tweet1">
                    <span class="iconFiller">
                        <span class="spaceManWilly">
                            <i class="sw sw-linkedin"></i>
                            <span class="swp_share"> Share</span>
   ...
   ?>
    ...
    <div class="social-icons-wrap small-icons test1">
        <ul class="social-icons">
            ...
            <!-- Facebook Button-->
            <li class="social-icon facebook demo">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.facebook.com/totalfrequencyshift" target="blank">
                    <i class="fa fa-facebook"></i>
                    <span class="share-text-fontz">Share</span>
                    <span class="share-count" data-sc-fb="<?php the_permalink(); ?>" ></span>
                </a>
            </li>
            <li class="social-icon insta_link inner3">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; //the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.instagram.com/energytherapyuk" target="_blank">
                <i class='fa fa-instagram'></i>
                    <span class="share-text-fontz"> Share </span>
                    <span class="share-count" data-sc-ln="<?php// the_permalink(); ?>" ></span>
                </a>
            </li>
            <li class="social-icon youtube_link">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;"  href="https://www.youtube.com/@energytherapyBiz" target="_blank">
                <i class='fa fa-youtube' style='color: white'></i>
                    <span class="share-text-fontz"> Share </span>
                    <span class="share-count" data-sc-ln="<?php// the_permalink(); ?>" ></span>
                </a>
            ...
            <li class="social-icon twitter">
                <a onclick="javascript:popupCenter('https://twitter.com/share?&amp;url=<?php echo $shortlink = wpbitly_get_shortlink_custom($permalink, $post_id); ?>&amp;text=Explore The <?php the_title(); ?>&amp;via=energy_therapy','Tweet', '540', '400');return false;" href="https://www.twitter.com/energy_therapy" target="blank">
			...
			<?php } else { ?>
			<li class="social-icon twitter">
                <a onclick="javascript:popupCenter('https://twitter.com/share?&amp;url=<?php echo $shortlink = wpbitly_get_shortlink_custom($permalink, $post_id); ?>&amp;text=<?php the_title(); ?>&amp;via=energy_therapy','Tweet', '540', '400');return false;" href="https://www.twitter.com/energy_therapy" target="blank">
                    <i class="fa fa-twitter"></i>
                    <span class="share-text-fontz"> Tweet </span>
                    <span class="share-count" data-sc-tw="<?php the_permalink(); ?>" ></span>
                </a>
            ...
            <li class="social-icon linkedin">
                <a onclick="javascript:popupCenter('http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $shortlink; ?>&amp;title=<?php the_title(); ?>&amp;source=<?php echo site_url(); ?>','Share on LinkedIn', '520', '570');return false;" href="https://www.linkedin.com/in/energytherapyuk" target="blank">
...
function ds_social_media_icons_author() {
    ...
    <div class="social-icons-wrap small-icons test1">
        <ul class="social-icons">
            ...
            <li class="social-icon insta_link inner4">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; //the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;"  href="https://www.instagram.com/energytherapyuk" target="_blank">
                <i class='fa fa-instagram'></i>
                    <span class="share-text-fontz"> Share </span>
                    <span class="share-count" data-sc-ln="<?php the_permalink(); ?>" ></span>
            ...
            <!-- Twitter Button -->
            <li class="social-icon twitter">
                <a onclick="javascript:popupCenter('https://twitter.com/share?&amp;url=<?php echo $shortlink = wpbitly_get_shortlink_custom($permalink, $post_id); ?>&amp;text=Explore Inspiring And Meaningful Quotes by <?php the_title(); ?>&amp;via=energy_therapy','Tweet', '540', '400');return false;" href="https://www.twitter.com/energy_therapy" target="blank">
                    <i class="fa fa-twitter"></i>
                    <span class="share-text-fontz"> Tweet </span>
                    <span class="share-count" data-sc-tw="<?php the_permalink(); ?>" ></span>
                </a>
            ...
            <!-- LinkedIn Button -->
            <li class="social-icon linkedin">
                <a onclick="javascript:popupCenter('http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $shortlink = wpbitly_get_shortlink_custom($permalink, $post_id); ?>&amp;title=<?php the_title(); ?>&amp;source=<?php echo site_url(); ?>','Share on LinkedIn', '520', '570');return false;" href="https://www.linkedin.com/in/energytherapyuk" target="blank">
                    <i class="fa fa-linkedin"></i>
                    <span class="share-text-fontz"> Share </span>
                    <span class="share-count" data-sc-ln="<?php the_permalink(); ?>" ></span>
                </a>
  ...
  //print_r(wpbitly_get_shortlink_custom($endpoint,$params));
    ...
    <div class="social-icons-wrap small-icons">
        <ul class="social-icons">
            <!-- Facebook Button-->
            <li class="social-icon facebook">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $actual_link; ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.facebook.com/totalfrequencyshift" target="blank">
                    <i class="fa fa-facebook"></i>
                    <span class="share-text-fontz"> Share</span>
                    <span class="share-count" data-sc-fb="<?php echo $actual_link; ?>" ></span>
                </a>
            </li>
            <li class="social-icon insta_link inner5">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; //the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.instagram.com/energytherapyuk" target="_blank" onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $actual_link; ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;">
                <i class='fa fa-instagram'></i>
                    <span class="share-text-fontz"> Share </span>
			...
			<li class="social-icon twitter">
                <a onclick="javascript:popupCenter('https://twitter.com/share?&amp;url=<?php echo $shortlink = wpbitly_get_shortlink_custom($endpoint,$params); ?>&amp;text=Explore The Latest Insightful And Meaningful Quotes On Energy Therapy&amp;via=energy_therapy','Tweet', '540', '400');return false;" href="https://www.twitter.com/energy_therapy" target="blank">
                    <i class="fa fa-twitter"></i>
                    <span class="share-text-fontz"> Tweet </span>
			...
			<li class="social-icon linkedin">
                <a onclick="javascript:popupCenter('http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $shortlink; ?>&amp;title=Quotes&amp;source=<?php echo $shortlink; ?>','Share on LinkedIn', '520', '570');return false;" href="https://www.linkedin.com/in/energytherapyuk" target="blank">
                    <i class="fa fa-linkedin"></i>
                    <span class="share-text-fontz"> Share </span>
                    <span class="share-count" data-sc-ln="<?php echo $actual_link; ?>" ></span>
                </a>
...
?>
	<div class="social-icons-wrap small-icons">
        <ul class="social-icons">
            ...
            <!-- Facebook Button-->
            <li class="social-icon facebook">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.facebook.com/totalfrequencyshift" target="blank">
                    <i class="fa fa-facebook"></i>
                    <span class="share-text-fontz"> Share</span>
                    <span class="share-count" data-sc-fb="<?php echo $link; ?>" ></span>
                </a>
            </li>
            <li class="social-icon insta_link inner6">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.instagram.com/energytherapyuk" target="_blank" >
                <i class='fa fa-instagram'></i>
                    <span class="share-text-fontz"> Share </span>
                    <span class="share-count" data-sc-ln="<?php echo $actual_link; ?>" ></span>
                </a>
            ...
            <li class="social-icon youtube_link">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.youtube.com/@energytherapyBiz" target="_blank">
<i class='fa fa-youtube' style='color: white'></i>
                    <span class="share-text-fontz"> Share </span>
                    <span class="share-count" data-sc-ln="<?php echo $actual_link; ?>" ></span>
                </a>
            ...
            <!-- Twitter Button -->
            <li class="social-icon twitter">
                <a onclick="javascript:popupCenter('https://twitter.com/share?&amp;url=<?php echo $shortlink = wpbitly_generate_shortlink($link, $term); ?>&amp;text=<?php single_cat_title(); ?>&amp;via=energy_therapy','Tweet', '540', '400');return false;" href="https://www.twitter.com/energy_therapy" target="blank">
                    <i class="fa fa-twitter"></i>
                    <span class="share-text-fontz"> Tweet </span>
            ...
            <!-- LinkedIn Button -->
            <li class="social-icon linkedin">
                <a onclick="javascript:popupCenter('http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $shortlink = wpbitly_get_shortlink_custom($link, $term); ?>&amp;title=<?php single_cat_title(); ?>&amp;source=<?php site_url(); ?>','Share on LinkedIn', '520', '570');return false;" href="https://www.linkedin.com/in/energytherapyuk" target="blank">
                    <i class="fa fa-linkedin"></i>
                    <span class="share-text-fontz"> Share </span>
...
function ds_social_media_small_icons_quotes($atts) {
    ...
    <div class="social-icons-wrap small-icons test1">
        <ul class="social-icons">
            ...
            <!-- Facebook Button-->
            <li class="social-icon facebook">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink($pid); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.facebook.com/totalfrequencyshift" target="blank">
                    <i class="fa fa-facebook"></i>
                    <span class="share-text-fontz"> Share</span>
                    <span class="share-count" data-sc-fb="<?php the_permalink($pid); ?>" ></span>
                </a>
            </li>
            <li class="social-icon insta_link inner7">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.instagram.com/energytherapyuk" target="_blank">
                <i class='fa fa-instagram'></i>
                    <span class="share-text-fontz"> Share </span>
                    <span class="share-count" data-sc-ln="<?php the_permalink(); ?>" ></span>
...
<i class='fa fa-youtube' style='color: white'></i>
            ...
            <!-- Twitter Button -->
            <li class="social-icon twitter">
                <a onclick="javascript:popupCenter('https://twitter.com/share?&amp;url=<?php echo $shortlink = wpbitly_get_shortlink_custom($permalink, $pid); ?>&amp;text=<?php echo get_the_title($pid); ?>&amp;via=energy_therapy','Tweet', '540', '400');return false;" href="https://www.twitter.com/energy_therapy" target="blank">
                    <i class="fa fa-twitter"></i>
                    <span class="share-text-fontz"> Tweet </span>
            ...
            <!-- LinkedIn Button -->
            <li class="social-icon linkedin">
                <a onclick="javascript:popupCenter('http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $shortlink = wpbitly_get_shortlink_custom($permalink, $pid); ?>&amp;title=<?php the_title(); ?>&amp;source=<?php echo site_url(); ?>','Share on LinkedIn', '520', '570');return false;" href="https://www.linkedin.com/in/energytherapyuk" target="blank">
                    <i class="fa fa-linkedin"></i>
                    <span class="share-text-fontz"> Share </span>
...
function ds_social_media_small_icons_home() {
    ...
    <div class="social-icons-wrap small-icons home">
        <ul class="social-icons">
            ...
            <!-- Facebook Button-->
            <li class="social-icon facebook demoa">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.facebook.com/totalfrequencyshift" target="blank">
                    <i class="fa fa-facebook"></i>
                    <span class="share-text-fontz"> Share</span>
                    <!--span class="share-count" data-sc-fb="<?php //the_permalink(); ?>" ></span-->
            ...
            <li class="social-icon insta_lin inner8">
                <a href="https://www.instagram.com/energytherapyuk" target="blank">
                <i class='fa fa-instagram'></i>
                    <span class="share-text-fontz"> Share </span>
                   <span class="share-count" data-sc-ln="<?php the_permalink(); ?>" ></span>
                </a>
            </li>
            <li class="social-icon youtube_lin">
                <a onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;" href="https://www.youtube.com/@energytherapyBiz" target="blank">
                <i class='fa fa-youtube' style='color: white'></i>
                    <span class="share-text-fontz"> Share </span>
                   <span class="share-count" data-sc-ln="<?php the_permalink(); ?>" ></span>
                </a>
            ...
            <li class="social-icon pinterest">
                <!--<a rel="nofollow" href="http://www.pinterest.com/pin/create/button/?url=<?php /*the_permalink(); */?>&media=<?php /*echo $pin_img_url = get_the_post_thumbnail_url($post_id); */?>&description=<?php /*the_title();*/?>" onclick="javascript:popupCenter('http://www.pinterest.com/pin/create/button/?url=<?php /*the_permalink();*/?>&media=<?php /*echo $pin_img_url = get_the_post_thumbnail_url($post_id); */?>&description=<?php /*the_title();*/?>','Pinit','scrollbars=yes,width=540,height=400');return false;"><i class="fa fa-pinterest"></i><span class="share-text-fontz"> Pin </span><span class="share-count"><?php /*echo $total_pinterest_count = get_pinterest_count( $post_id ); $pinterest_count = get_pinterest_count( $post_id ); if($pinterest_count < 1000000 && $pinterest_count > 750) {$pinterest_count = round($pinterest_count/1000); echo $pinterest_count."K";} else if($pinterest_count == 0){} else if($pinterest_count > 1000000) { $pinterest_count = round($pinterest_count/1000000);echo $pinterest_count."M";} else {echo $pinterest_count;} */?></span></a>-->
                <a rel="nofollow" href="https://www.pinterest.com/energytherapyuk" onclick="var e=document.createElement('script');e.setAttribute('type','text/javascript');e.setAttribute('charset','UTF-8');e.setAttribute('src','//assets.pinterest.com/js/pinmarklet.js?r='+Math.random()*99999999);document.body.appendChild(e);" class="nc_tweet1 noPop">
                    <i class="fa fa-pinterest"></i>
                    <span class="share-text-fontz"> Pin </span>
                    <!--span class="share-count" data-sc-pr="<?php //the_permalink(); ?>" ></span-->
                </a>
