...
})(window,document,'script','dataLayer','GTM-NKZG2NN');</script>
...
.social-div i.fa.fa-instagram:before {
    left: -3px;
    top: -7px !important;
}
		}
    ...
    top: 2px;
		...
		li.social-icon.telegram_lin {
    display: none !important;
}
.nc_tweetContainer.insta_link,li.social-icon.insta_lin{
    border: #E4405F;
    background-color: #E4405F;
}
.nc_tweetContainer.youtube_link, li.social-icon.youtube_lin  {
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NKZG2NN"
				...
				<div class="topbar">
					...
					<div class="social-div">
						<ul class="social-share" itemscope itemtype="http://schema.org/Organization">
							...
							<li><a itemprop="sameAs" href="<?php the_field('facebook_link','options'); ?>" target="_blank" title="Join us on Telegram"><i class="fa fa-facebook" aria-hidden="true"></i></a></li> 
							<?php } ?>
							...
							<li><a itemprop="sameAs" href="<?php the_field('instagram_link','options'); ?>" target="_blank" title="Join us on Telegram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li> 
							<?php } ?>
							...
							<li><a itemprop="sameAs" href="<?php the_field('linkedin_link','options'); ?>" target="_blank" title="Youtube"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
							<?php  } ?>
							<?php if(wp_is_mobile()){ ?>
					...
					<div class="div100">
						...
						<div style="display: block;" id="category_posts_sub_menu_14854" class="category_posts_sub_menu inactive animate-drop slide-top" data-cid="14854">
							<div class="medium-12 column">
								...
								<div class="discover-posts divtab owl-carousel owl-theme test" id="posts" style="display:none;">
									<?php
									 $args = array('post_type'=> 'post','posts_per_page' => 5,'category__not_in' => '3401');
									query_posts($args);
						...
						<div style="display: block;" id="category_posts_sub_menu_14855" class="category_posts_sub_menu inactive animate-drop slide-top" data-cid="14855">
							<div class="medium-12 column">
								...
								<div class="category-0">
									<?php $args = array('orderby' => 'post_date', 'order' => 'DESC', 'posts_per_page' => 5,'post_status' => 'publish', 'category__not_in' => '3401');
									query_posts($args);
									while (have_posts()) : the_post(); ?>
										<div class="category_submenu_post">
											<a class="th post-thumbnail" href="<?php the_permalink(); ?>">
								...
								<div class="category-3" style="display: none">
									<?php $args = array('cat' => 2, 'orderby' => 'post_date', 'order' => 'DESC', 'posts_per_page' => 5,'post_status' => 'publish','category__not_in' => '3401');
									query_posts($args);
									while (have_posts()) : the_post(); ?>
										<div class="category_submenu_post">
											<a class="th post-thumbnail" href="<?php the_permalink(); ?>">
								...
								<div class="category-4" style="display: none">
									<?php $args = array('cat' => 9, 'orderby' => 'post_date', 'order' => 'DESC', 'posts_per_page' => 5,'post_status' => 'publish','category__not_in' => '3401');
									query_posts($args);
									while (have_posts()) : the_post(); ?>
										<div class="category_submenu_post">
											<a class="th post-thumbnail" href="<?php the_permalink(); ?>">
								...
								<div class="category-7" style="display: none">
									<?php $args = array('cat' => 5, 'orderby' => 'post_date', 'order' => 'DESC', 'posts_per_page' => 5,'post_status' => 'publish','category__not_in' => '3401');
									query_posts($args);
									while (have_posts()) : the_post(); ?>
										<div class="category_submenu_post">
											<a class="th post-thumbnail" href="<?php the_permalink(); ?>">
