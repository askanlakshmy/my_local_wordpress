    ...
    <ul class="social-icons">
        <div class="nc_socialPanel swp_flatFresh swp_d_fullColor swp_i_fullColor swp_o_fullColor scale-100 scale-fullWidth" data-position="both" data-float="floatNone" data-count="6" data-floatColor="#ffffff" data-emphasize="0">
            ...
            <div class="nc_tweetContainer youtube_link">
                <a rel="nofollow" onclick="javascript:popupCenter('https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>&amp;appId=energytherapy','Facebook Share', '540', '400');return false;"  href="https://www.youtube.com/@energytherapyBiz" target="_blank" class="nc_tweet1">
                    <span class="iconFiller">
                        <span class="spaceManWilly">
